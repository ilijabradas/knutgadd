...
DELETE FROM `catalog_product_entity_group_price` WHERE (`currency` IS NOT NULL) OR (`store_id` <> 0);
ALTER TABLE `catalog_product_entity_group_price` DROP `currency`;
ALTER TABLE `catalog_product_entity_group_price` DROP FOREIGN KEY FK_CATALOG_PRODUCT_ENTITY_GROUP_PRICE_STORE_ID;
ALTER TABLE `catalog_product_entity_group_price` DROP `store_id`;

TRUNCATE TABLE `catalog_product_index_group_price`;
ALTER TABLE `catalog_product_index_group_price` DROP `currency`;
ALTER TABLE `catalog_product_index_group_price` DROP FOREIGN KEY FK_CATALOG_PRODUCT_INDEX_GROUP_PRICE_STORE_ID;
ALTER TABLE `catalog_product_index_group_price` DROP `store_id`;
