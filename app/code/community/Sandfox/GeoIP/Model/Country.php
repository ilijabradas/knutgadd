...
class Sandfox_GeoIP_Model_Country extends Sandfox_GeoIP_Model_Abstract
{
    ...
    public function __construct()
    {
        ...
        $ip_address = isset($_SERVER["HTTP_CF_CONNECTING_IP"]) ? $_SERVER["HTTP_CF_CONNECTING_IP"] : Mage::helper('core/http')->getRemoteAddr();
        $this->country = $this->getCountryByIp($ip_address);
