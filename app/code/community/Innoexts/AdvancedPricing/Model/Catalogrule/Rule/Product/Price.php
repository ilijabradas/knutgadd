 ...
 */
class Innoexts_AdvancedPricing_Model_Catalogrule_Rule_Product_Price 
    extends Mage_CatalogRule_Model_Rule_Product_Price 
{
    ...
    public function applyPriceRuleToIndexTable2(
        Varien_Db_Select $select, $indexTable, $entityId, $customerGroupId, $currency, 
        $websiteId, $storeId, $updateFields, $websiteDate
    ) 
    {
        $this->_getResource()->applyPriceRuleToIndexTable2(
            clone $select, $indexTable, $entityId, $customerGroupId, $currency, $websiteId, $storeId, 
            $updateFields, $websiteDate
        );
        return $this;
    }
