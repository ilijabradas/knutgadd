 ...
 */
class Innoexts_AdvancedPricing_Model_Catalogrule_Action_Index_Refresh 
    extends Mage_CatalogRule_Model_Action_Index_Refresh 
{
    ...
    protected function _removeOldIndexData2(Mage_Core_Model_Store $store)
    {
        $adapter = $this->_connection;
        $adapter->delete(
            $this->getTable('catalogrule/rule_product_price'), array('store_id = ?' => $store->getId())
        );
    }
    /**
     * Fill Index Data
