 ...
 */
class Innoexts_AdvancedPricing_Model_Catalog_Product_Attribute_Backend_Tierprice 
    extends Mage_Catalog_Model_Product_Attribute_Backend_Tierprice 
{
    ...
    public function validate($object)
    {
        ...
        if ($productHelper->isGroupPriceFixed($object)) {
            $duplicateMessage = $helper->__('Duplicate website tier price store, customer group, quantity and currency.');
        } else {
