 ...
 */
abstract class Innoexts_AdvancedPricing_Block_Adminhtml_Promo_Catalog_Edit_Tab_Actions_Compound_Renderer_Abstract 
    extends Innoexts_Core_Block_Adminhtml_Widget_Form_Element_Renderer_Abstract 
{
    ...
    {
        $this->setTemplate(
            'innoexts/advancedpricing/promo/catalog/edit/tab/actions/compound/renderer/abstract.phtml'
        );
    }
    /**
