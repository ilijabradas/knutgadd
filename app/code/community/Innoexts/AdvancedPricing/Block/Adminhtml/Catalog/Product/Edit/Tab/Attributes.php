 ...
 */
class Innoexts_AdvancedPricing_Block_Adminhtml_Catalog_Product_Edit_Tab_Attributes 
    ...
    protected function _prepareForm()
    {
        ...
        if ($form->getElement('special_price')) {
            $fieldset->addField('compound_special_prices', 'text', array(
                ...
                'advancedpricing/adminhtml_catalog_product_edit_tab_price_compoundSpecial_renderer'
            ));
        }
        return $this;
    }
