 ...
 */
class Innoexts_AdvancedPricing_Block_Adminhtml_Catalog_Product_Edit_Tab_Price_Group_Renderer 
    extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Price_Group 
{
    ...
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate(
            'innoexts/advancedpricing/catalog/product/edit/tab/price/group/renderer.phtml'
        );
    }
    /**
     * Get control HTML id
