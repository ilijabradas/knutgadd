 ...
 */
class Innoexts_AdvancedPricing_Block_Adminhtml_Store_Switcher_Form_Renderer_Fieldset_Element 
    ...
    implements Varien_Data_Form_Element_Renderer_Interface 
{
    ...
    {
        $this->setTemplate('innoexts/advancedpricing/store/switcher/form/renderer/fieldset/element.phtml');
    }
    /**
     * Retrieve an element
     *
