 ...
 */
class Innoexts_AdvancedPricing_Helper_Catalogrule_Rule 
    extends Innoexts_Core_Helper_Abstract 
{
     ...
     * @return float
     */
    protected function _getCompoundAmount($rule, $attributeCode, $actionCode, $storeId, $currencyCode)
    {
     ...
     * @return float
     */
    public function getCompoundDiscountAmount($rule, $storeId, $currencyCode)
    {
     ...
     * @return float
     */
    public function getCompoundSubDiscountAmount($rule, $storeId, $currencyCode)
    {
        return $this->_getCompoundAmount(
            $rule, 
            'sub_discount_amount', 
