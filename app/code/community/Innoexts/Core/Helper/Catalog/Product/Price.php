    ...
    extends Innoexts_Core_Helper_Abstract 
{
     ...
     * @var Mage_Catalog_Model_Resource_Eav_Attribute
     */
    protected $_specialPriceAttribute;
    /**
     * Get product helper
     * 
    ...
    /**
     * Get special price attribute
     * 
     * @return Mage_Catalog_Model_Resource_Eav_Attribute 
     */
    public function getSpecialPriceAttribute()
    {
        if (is_null($this->_specialPriceAttribute)) {
            $attribute = $this->getProductHelper()->getAttribute('special_price');
            if ($attribute) {
                $this->_specialPriceAttribute = $attribute;
            }
        }
        return $this->_specialPriceAttribute;
    }
    /**
