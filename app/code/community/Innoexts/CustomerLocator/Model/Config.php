 ...
 * @copyright   Copyright (c) 2016 Innoexts (http://www.innoexts.com)
    ...
    extends Varien_Object 
{
    ...
    const XML_PATH_CUSTOMER_LOCATOR_OPTION_SYNCHRONIZE_QUOTE_ADDRESS       = 'customerlocator/options/synchronize_quote_address';
    ...
    /**
     * Check if customer address should be synchronized with quote address
     * 
     * @param mixed $store
     * 
     * @return boolean
     */
    public function isSynchronizeQuoteAddress($store = null)
    {
        return Mage::getStoreConfigFlag(self::XML_PATH_CUSTOMER_LOCATOR_OPTION_SYNCHRONIZE_QUOTE_ADDRESS, $store);
    }
    /**
