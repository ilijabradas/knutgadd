 ...
 */
class Innoexts_Shell_AdvancedPricing_Catalog_Product_Price_Group_Import 
...
$shell = new Innoexts_Shell_AdvancedPricing_Catalog_Product_Price_Group_Import();
$shell->run();

/**
 * 

php shell/Innoexts/AdvancedPricing/Catalog/Product/Price/Group/Import.php \
