...
require_once rtrim(dirname(__FILE__), '/').'/../../../../../Core/Catalog/Product/Price/Compound/Import.php';
 ...
 */
class Innoexts_Shell_AdvancedPricing_Catalog_Product_Price_Compound_Import 
    extends Innoexts_Shell_Core_Catalog_Product_Price_Compound_Import 
{
    /**
...
$shell = new Innoexts_Shell_AdvancedPricing_Catalog_Product_Price_Compound_Import();
$shell->run();

/**
 * 

php shell/Innoexts/AdvancedPricing/Catalog/Product/Price/Compound/Import.php \
...
php shell/Innoexts/AdvancedPricing/Catalog/Product/Price/Compound/Import.php \
    ...
    --file-filename product-compound-price.csv
