...
require_once rtrim(dirname(__FILE__), '/').'/../../../../../Core/Catalog/Product/Price/CompoundSpecial/Export.php';
 ...
 */
class Innoexts_Shell_AdvancedPricing_Catalog_Product_Price_CompoundSpecial_Export 
    extends Innoexts_Shell_Core_Catalog_Product_Price_CompoundSpecial_Export 
{
    /**
...
$shell = new Innoexts_Shell_AdvancedPricing_Catalog_Product_Price_CompoundSpecial_Export();
$shell->run();

/**
 * 

php shell/Innoexts/AdvancedPricing/Catalog/Product/Price/CompoundSpecial/Export.php \
