...
require_once rtrim(dirname(__FILE__), '/').'/../../../../../Core/Catalog/Product/Price/CompoundSpecial/Import.php';
 ...
 */
class Innoexts_Shell_AdvancedPricing_Catalog_Product_Price_CompoundSpecial_Import 
    extends Innoexts_Shell_Core_Catalog_Product_Price_CompoundSpecial_Import 
{
    /**
    ...
    protected function getDatumAdditionalValues($row)
    {
        ...
        if ($currency) {
            ...
            $this->printMessage("Currency is empty");
            return null;
        }
...
$shell = new Innoexts_Shell_AdvancedPricing_Catalog_Product_Price_CompoundSpecial_Import();
$shell->run();

/**
 * 

php shell/Innoexts/AdvancedPricing/Catalog/Product/Price/CompoundSpecial/Import.php \
...
php shell/Innoexts/AdvancedPricing/Catalog/Product/Price/CompoundSpecial/Import.php \
    ...
    --file-filename product-compound-special-price.csv
