...
require_once rtrim(dirname(__FILE__), '/').'/../../../../../Core/Catalog/Product/Price/Tier/Export.php';
 ...
 */
class Innoexts_Shell_AdvancedPricing_Catalog_Product_Price_Tier_Export 
    extends Innoexts_Shell_Core_Catalog_Product_Price_Tier_Export 
{
    /**
...
$shell = new Innoexts_Shell_AdvancedPricing_Catalog_Product_Price_Tier_Export();
$shell->run();

/**
 * 

php shell/Innoexts/AdvancedPricing/Catalog/Product/Price/Tier/Export.php \
